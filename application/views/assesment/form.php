        ...
        <div class="navbar">
            <div class="navbar-inner">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Penilaian KD <span class="divider">/</span></li>
...
<div class="span3" id="sidebar">
    <div class="row-fluid">
        <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
            ...
            <li><a href="<?= site_url('/assesment' . '/' . ($breadcrumb === 'Pengetahuan' ? 'knowledge' : 'skill') . '?class=' . $curClassId . '&pel=' . $course->id) ?>"><i class="icon-chevron-right"></i> <?= strtoupper($course->fullname) ?></a></li>
            <?php endforeach; ?>
            <?php endif; ?>
        </ul>
    </div>
            ...
            <div class="block-content collapse in">
                <div class="span12">
                    <div class="pagination pagination-small">
                        ...
                        <ul>
                            <li class="<?= ($item->classid === $curClassId ? "active" : "") ?>"><a href="<?= site_url('/assesment' . '/' . ($breadcrumb === 'Pengetahuan' ? 'knowledge' : 'skill')  . '?class=' . $item->classid) ?>">Kelas <?= $item->class_name ?></a></li>
                        </ul>
                        <?php endforeach; ?>
                    </div>
